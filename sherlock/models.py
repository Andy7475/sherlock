...
class Argument(BaseModel):
    ...
    subclaim_ids: List[str] = []  # IDs of other claims this argument depends on

class Likelihood(BaseModel):
    supporting: int = Field(description="The number of supporting arguments", ge=0, default=0)
    opposing: int = Field(description="The number of opposing arguments", ge=0, default=0)
...
class Claim(BaseModel):
    ...
    def add_argument(self, text: str, supports: bool, 
                    evidence_ids: List[str] = [], 
                    subclaim_ids: List[str] = []) -> str:
